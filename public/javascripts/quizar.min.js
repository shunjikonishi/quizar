...
}function r(){z=null,B=null,console.log("Ranking#clear")}var s=["rank","username","correctCount","time"],t=["title",["username","r-winners"],"correctCount","time"],u=["rank","username","point","correctCount"],v=["title","rank","point","correctCount"],w={username:"r-name",correctCount:"r-correct"},x=null,y=null,z=null,B=null;$.extend(this,{init:p,afterShow:q,clear:r})}function x(){function a(a,b,d){c&&c.log(a,b,d)}function b(a){c=a}var c=null;$.extend(this,{log:a,setImpl:b})}function y(a,b){function c(a,b,c){"object"==typeof b&&(b=JSON.stringify(b)),f>d&&e.find("tr:first").remove();var g=$("<tr><td></td><td></td><td><div class='pull-right'></div></td></tr>"),h=g.find("td");$(h.get(0)).text(a),$(h.get(1)).text(b),c&&$(h.get(2)).find("div").text(c),e.append(g),f++,console.log(a+", "+b+(c?", "+c+"ms":""))}var d=10,e=a.find("table tbody"),f=0;b.onRequest(function(a,b){var d=a;b&&(d+=", "+JSON.stringify(b)),c("send",d)}).onMessage(function(a,b){var d=(new Date).getTime();c("receive",JSON.stringify(a),d-b)}),$("#chk-use-ajax").bootstrapSwitch().on("switchChange",function(){var a=$(this).is(":checked");b.useAjax(a?"/ajax":!1)}),$("#btn-debug-msg").click(function(){$("#effect-dialog").animateDialog("Start!",{name:"rotateZoom"});var a=$(".publish-q-animation");a.css({"animation-name":"inout","-webkit-animation-name":"inout"}),a.hide(),setTimeout(function(){a.show()},0)}),$.extend(this,{log:c})}$.validator.addMethod("quizChoices",function(a){if(!a||0==a.length)return!1;var b=a.split("\n").filter(function(a){return a.length>0});return b.length<=1||b.length>5?!1:!0},MSG.invalidQuizChoices),$.validator.addMethod("time",function(a,b){return this.optional(b)||/^\d{2}:\d{2}$/.test(a)},MSG.invalidTime);var z="ontouchstart"in window,A=300,B="/assets/images/twitter_default_profile.png",C={FirstRow:0,Most:1,Least:2,NoAnswer:3},D={Prepared:0,Running:1,Finished:2},A=300;flect.QuizApp=function(a){function b(a,b){var c=$.extend({name:a},bb[a]);b&&(c.effect="none"),Y.children("div").hide(),T.show(c)}function c(a,b){function c(){d.is(":visible")||(Y.children("div").hide(),d.show("slide",{direction:"right"},A))}var d=$("#"+a);b?$.sidr("close",c):c()}function d(){c("chat",!1)}function e(){var a={name:"mypage",direction:"left",beforeShow:N.init,afterHide:N.clear};Y.children("div").hide(),T.show(a)}function f(a){var b={name:"publish-question",beforeShow:function(b){W.setLookback(a),W.init(b)},afterHide:function(){W.clear(),W.setLookback(null)}};Y.children("div").hide(),T.show(b)}function g(a){if(W){var b={name:"publish-question",effect:"none",beforeShow:function(b){a&&W.setQuestion(a),W.init(b)},afterShow:W.afterShow,afterHide:W.clear};Y.children("div").hide(),T.show(b)}}function h(){b("ranking")}function i(a){if(V){var b=$.extend({name:"edit-question"},bb["edit-question"]);a&&("none"==a?b.effect="none":b.direction=a),Y.children("div").hide(),T.show(b)}}function B(a){O&&(a&&O.edit(a),Y.children("div").hide(),T.show({name:"make-question",beforeShow:O.init,afterHide:O.clear}))}function C(){S&&(Y.children("div").hide(),T.show({name:"passcode",beforeShow:S.init,afterHide:S.clear}))}function D(a,b){J.show(a,b)}function E(a,b){K.show(a,b)}function F(a,b){U&&U.tweet(a,b)}function G(){if(window.sessionStorage&&sessionStorage.clear(),I=new x,J=new flect.MessageDialog($("#msg-dialog")),K=new j($("#effect-dialog")),L=new flect.Connection(_.uri,I),M=new m(L,ab,_.userId),T=new flect.TemplateManager(L,$("#content-dynamic")),W=new s(Z,_,L),Y=$("#content"),_.isDebug()&&(I.setImpl(new y($("#debug"),L,J)),$("#btn-debug").click(function(){return c("debug",!0),!1}),L.onOpen(function(a){console.log("onOpen"),console.log(a)}).onClose(function(a){console.log("onClose"),console.log(a)}).onSocketError(function(a){console.log("onSocketError"),console.log(a)}).onServerError(function(a){console.log(a),alert(a)})),L.addEventListener("redirect",function(a){location.href=a}),_.isLogined()&&(ab[_.userId]=new l({id:_.userId,name:_.username,imageUrl:_.userImage}),N=new n(Z,_,ab,L),P=new p(app,_.userId,L)),_.isInRoom()){var a=$("#chat");U=new o(a,_.userId,_.hashtag,L),$(".menu-chat").click(function(){return c("chat",$(this).parents("#sidr").length>0),!1}),$("#toolbar-ranking").click(function(){return h(),!1}),$("#toolbar-question").click(function(){return _.isEventAdmin()?i():g(),!1}),L.addEventListener("chat",function(a){U.append(a),a.userId!=_.userId&&U.isNotifyTweet()&&J.notifyTweet(a)}),L.addEventListener("member",U.member),L.addEventListener("newEntry",function(a){var b=new l(a);ab[b.id]=b,J.notifyUserAction(b,MSG.newEntry)}),L.ready(function(){0==U.member()&&L.request({command:"member"})}),L.addEventListener("startEvent",function(a){var b=a.id,c=a.admin;K.show(MSG.start),_.openEvent(b,c==_.userId),O&&O.openEvent(_.eventId),S&&setTimeout(S.openEvent,3e3)}),L.addEventListener("finishEvent",function(){K.show(MSG.finish),_.closeEvent(),O&&O.closeEvent(),S&&S.closeEvent()}),L.addEventListener("question",function(a){g(a)}),L.addEventListener("answer",W.receiveAnswer),L.addEventListener("answerDetail",W.receiveAnswerDetail),X=new w(Z,_,ab,L)}(_.isRoomAdmin()||_.isPostQuestionAllowed())&&(O=new r(Z,_,L),_.isEventRunning()&&O.openEvent(_.eventId)),_.isRoomAdmin()&&(V=new q(Z,ab,_,L),Q=new u(Z,_,L),L.addEventListener("postQuestion",function(a){var b=a,c=ab[b];V.reload(),c?J.notifyUserAction(c,MSG.postQuestionMessage):L.request({command:"getUser",data:b,success:function(a){var b=new l(a);ab[b.id]=b,J.notifyUserAction(b,MSG.postQuestionMessage)}})}),R=new v(Z,_,L)),_.canEntryEvent()&&(S=new t(Z,_,L)),$("#btn-menu").sidr({onOpen:function(){$("#toolbar").css("left","260px").find(".header-center").hide()},onClose:function(){$("#toolbar").css("left","0px").find(".header-center").show()}}),$("#content").swipe({swipeLeft:function(){$.sidr("close")},swipeRight:function(){$.sidr("open")},tap:function(a,b){z&&$(b).click()}}),L.polling(25e3,{command:"noop",log:"user="+(_.isLogined()?_.username:"(Anonymous)")}),$("#sidr a.dynamic").click(function(){var a=$(this).attr("href").substring(1),b=$.extend({name:a},bb[a]);return $.sidr("close",function(){Y.children("div").hide(),T.show(b)}),!1}),$(".dropdown-button").click(function(){return $(this).next("ul").toggle(),!1}),$(".dropdown-menu a").click(function(){var a=$(this);return a.parents(".dropdown-menu").hide(),"#"!=a.attr("href")})}function H(){function a(){location.href="/room/"+_.roomId}var c=location.pathname;if("/"==c||"/home"==c)b("home",!0);else if("/makeRoom"==c)b("make-room",!0);else if("/help"==c)b("help",!0);else{var d=c.substring(1).split("/");switch(2==d.length&&d.push(_.isRoomAdmin()?"questionList":"chat"),d[2]){case"question":g();break;case"ranking":b("ranking",!0);break;case"chat":$("#chat").show();break;case"editRoom":_.isRoomAdmin()?b("edit-room",!0):a();break;case"event":_.isRoomAdmin()?b("edit-event",!0):a();break;case"questionList":_.isRoomAdmin()?i("none"):a();break;case"postQuestion":!_.isRoomAdmin()&&_.isPostQuestionAllowed()?b("post-question",!0):a()}}}var I,J,K,L,M,N,O,P,Q,R,S,T,U,V,W,X,Y,Z=this,_=new k(a),ab={};G(),I.log("params",_);var bb={home:{beforeShow:M.init,afterHide:M.clear}};_.isLogined()&&$.extend(bb,{mypage:{beforeShow:function(a){N.reset(),N.init(a)},afterHide:N.clear},"make-room":{beforeShow:function(a){P.clear(),P.init(a)},afterHide:P.clear},"publish-question":{name:"publish-question",beforeShow:W.init,afterHide:W.clear},"edit-room":{name:"make-room",beforeShow:function(a){P.clear(),P.edit(_.roomId),P.init(a)},afterHide:P.clear}}),_.isRoomAdmin()?($.extend(bb,{"edit-question":{beforeShow:V.init,afterHide:V.clear}}),$.extend(bb,{"edit-event":{beforeShow:function(a){_.isEventRunning()?R.init(a):Q.init(a)},name:function(){return _.isEventRunning()?"event-members":"edit-event"},afterHide:function(){_.isEventRunning()?R.clear():Q.clear()}}})):_.isPostQuestionAllowed()&&$.extend(bb,{"post-question":{name:"make-question",beforeShow:O.init,afterHide:O.clear}}),_.isInRoom()&&$.extend(bb,{ranking:{name:"ranking",beforeShow:X.init,afterShow:X.afterShow,afterHide:X.clear}}),$.extend(this,{showQuestionList:i,showMakeQuestion:B,showPasscode:C,showChat:d,showRanking:h,showQuestion:g,showLookback:f,showMessage:D,showEffect:E,backToMypage:e,tweet:F}),L.ready(H)}});